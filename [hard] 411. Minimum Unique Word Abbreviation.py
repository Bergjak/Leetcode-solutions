class Solution:
    def minAbbreviation(self, target: str, dictionary: List[str]) -> str:
        ...
        for word in candidates:
            ...
            # So, now zeros in these bitmasks are where target and word are equal
            # therefore, we want a bitmask m of target s.t. m & diff_num != 0, wherein a 1 bit of m occurs if we are making that part of the abbreviation a letter
            diffs.add(diff_num)
